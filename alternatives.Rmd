...
## Boundary Commission proposal but only moving two wards

The Boundary Commission appears to have prioritised creating two constituencies of near-equal size. This has meant moving four wards: **Sowerby Bridge**, **Warley**, **Brighouse**, and **Rastrick**. In fact, exchanging **Sowerby Bridge** and **Rastrick** wards only would result in two constituencies of the correct size. This would achieve the aims of the review but with less disruption to existing arrangements.
...
This map shows the effect of moving the **Wainstalls**, **Luddenden**, **Luddendenfoot** and **Warley Wood** districts (shown in pink) into Halifax. This moves 3,374 electors.
...
This would leave the proposed Batley and Hipperholme with 66,845 electors - 2,879 short of the minimum required.